...
import { GetAllWorkouts } from '../../../../src/domain/use-cases/workout/get-all-workouts';


describe('Get All Workouts Use Case', () => {
    ...
    test('should return data', async () => {
        ...
        jest.spyOn(mockWorkoutRepository, 'getWorkouts').mockImplementation(() => Promise.resolve(expectedResult));

        const getAllWorkoutsUseCase = new GetAllWorkouts(mockWorkoutRepository);
        const result = await getAllWorkoutsUseCase.execute();
